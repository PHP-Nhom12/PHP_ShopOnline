        ...
        <div class="portlet light portlet-fit ">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-red bold uppercase">Sản Phẩm Mới</span>
                </div>
                <div class="tools">
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                            <div class="mt-card-item">
                                ...
                                <div class="mt-card-content">
                                    <h3 class="mt-card-name">Long Tee Black/White</h3>
                                    <p class="mt-card-desc font-grey-mint">2,000,000 VNĐ</p>
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                            <div class="mt-card-item">
                                ...
                                <div class="mt-card-content">
                                    <h3 class="mt-card-name">Jean Jacket Dark Blue</h3>
                                    <p class="mt-card-desc font-grey-mint">3,000,000 VNĐ</p>
                                    <div class="mt-card-social">
                                        <ul>
                                            <li>
                                                <a href="javascript:;" class="btn btn-transparent btn-no-border btn-circle font-green-meadow font-hover-white bg-hover-green-meadow tooltips" data-original-title="Thêm vào giỏ">
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                            <div class="mt-card-item">
                                ...
                                <div class="mt-card-content">
                                    <h3 class="mt-card-name">Basic Tee</h3>
                                    <p class="mt-card-desc font-grey-mint">1,000,000 VNĐ</p>
                                    <div class="mt-card-social">
                                        <ul>
                                            <li>
                                                <a href="javascript:;" class="btn btn-transparent btn-no-border btn-circle font-green-meadow font-hover-white bg-hover-green-meadow tooltips" data-original-title="Thêm vào giỏ">
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                            <div class="mt-card-item">
                                ...
                                <div class="mt-card-content">
                                    <h3 class="mt-card-name">OFF WHITE TEE</h3>
                                    <p class="mt-card-desc font-grey-mint">5,000,000 VNĐ</p>
                                    <div class="mt-card-social">
                                        <ul>
                                            <li>
                                                <a href="javascript:;" class="btn btn-transparent btn-no-border btn-circle font-green-meadow font-hover-white bg-hover-green-meadow tooltips" data-original-title="Thêm vào giỏ">
