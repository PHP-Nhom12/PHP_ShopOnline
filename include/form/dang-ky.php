...
if(isset($_POST['username-register']) && isset($_POST['password-register'])) {
  ...
  // Phần xử lý của các bạn..
    $sql = "SELECT * FROM TAIKHOAN WHERE tentaikhoan='$username' AND email ='$email'";
    $member = mysql_query($sql);     
    if (mysql_num_rows($member)==1)//Thành công     
    {    
        $_SESSION['myname'] = $name; // Lưu name vào session
        echo '<p class="success">Chúc mừng bạn <span style="color:blue">'.$_SESSION['myname'].'</span> đã đăng nhập thành công <br><a href="logout.php">Đăng xuất</a> !</p>'; 
    }
    else //Thất bại 
...
<form class="register-form" method="post">
    ...
    <div class="form-group">
        ...
        <input class="form-control placeholder-no-fix" type="text" autocomplete="off" placeholder="Tên tài khoản" name="username" /> </div>
    <div class="form-group">
