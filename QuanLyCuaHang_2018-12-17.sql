...
LOCK TABLES `BannerQuangCao` WRITE;
/*!40000 ALTER TABLE `BannerQuangCao` DISABLE KEYS */;

INSERT INTO `BannerQuangCao` (`id`, `tenchiendich`, `vitri`, `thoigianbatdau`, `thoigianketthuc`, `hinhanh`, `daxoa`)
VALUES
	(1,'Nike','index','2018-01-01','2020-01-01','https://content.nike.com/content/dam/one-nike/en_lu/HO18/Homepage/APLA/1206/Ho18_AJXI_Concord_HP_1600x600.jpg.transform/full-screen/Ho18_AJXI_Concord_HP_1600x600.jpg',b'0'),
	(2,'Nike','index','2018-01-01','2020-01-01','https://content.nike.com/content/dam/one-nike/en_lu/HO18/Homepage/APLA/1204/12.4_HP_Generic_Gifting_DT.jpg.transform/full-screen/12.4_HP_Generic_Gifting_DT.jpg',b'0'),
	(3,'Nike','index','2018-01-01','2020-01-01','https://content.nike.com/content/dam/one-nike/en_lu/HO18/Homepage/APLA/1204/12.4_HP_NW_RN_VaporMax_MOB.jpg.transform/full-screen/12.4_HP_NW_RN_VaporMax_MOB.jpg',b'0'),
	(4,'Nike','index','2018-01-01','2020-01-01','https://content.nike.com/content/dam/one-nike/en_lu/HO18/Homepage/APLA/1204/NIKE429_.com_Ho18_NBA_City_Edition_Desktop_Starter_Image.jpg.transform/full-screen/NIKE429_.com_Ho18_NBA_City_Edition_Desktop_Starter_Image.jpg',b'0');

/*!40000 ALTER TABLE `BannerQuangCao` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `ChiTietSP` (`id`, `idsanpham`, `idmausac`, `idkichthuoc`, `chatlieu`, `gioitinh`, `daxoa`)
VALUES
	(1,'SP001',1,1,'cotton',1,b'0'),
	(2,'SP002',2,2,'cotton',1,b'0'),
	(4,'SP002',1,1,'cotton',1,b'0');
...
VALUES
	(1,'SP001','/assets/images/SP001.jpg',b'1',b'0'),
	(2,'SP002','/assets/images/SP002.jpg',b'1',b'0'),
	(3,'SP003','/assets/images/SP003.jpg',b'1',b'0'),
	(4,'SP004','/assets/images/SP004.jpg',b'1',b'0'),
	(5,'SP002','/assets/images/SP002_0.jpg',b'0',b'0'),
	(6,'SP002','/assets/images/SP002_1.jpg',b'0',b'0'),
	(7,'SP003','/assets/images/SP003_0.jpg',b'0',b'0'),
	(8,'SP003','/assets/images/SP003_1.jpg',b'0',b'0');
...
CREATE TABLE `HOADON` (
  ...
  `tenkhachhang` varchar(255) NOT NULL DEFAULT '',
  `cmnd` int(9) NOT NULL,
  `diachi` varchar(255) NOT NULL DEFAULT '',
  `sdt` varchar(13) NOT NULL DEFAULT '',
...
VALUES
	(1,0,'Thời Trang Nam',b'0'),
	(2,0,'Thời Trang Nữ',b'0'),
	(3,0,'Phụ kiện',b'0'),
	(4,1,'Áo Nam',b'0'),
	(5,1,'Quần Nam',b'0'),
...
VALUES
	...
	('SP002',1,'Jean Jacket Dark Blue',6,'100% Jean',450000,100,b'0'),
	('SP003',1,'Basic Tee',4,'100% Cotton',150000,100,b'0'),
	('SP004',1,'OFFWHITE Tee',7,'100% Cotton',650000,100,b'0'),
	('SP005',2,'Tee',6,'100% Cotton',300000,100,b'1'),
	('SP006',3,'Basic Tee',6,'100% Cotton',300000,100,b'0'),
	('SP007',3,'Basic Tee',6,'100% Cotton',300000,100,b'0'),
	('SP008',3,'Basic Tee',6,'100% Cotton',300000,100,b'0'),
	('SP009',3,'Basic Tee',7,'100% Cotton',300000,100,b'0'),
	('SP010',3,'Basic Tee',6,'100% Cotton',300000,100,b'0'),
	...
	('SP021',3,'BASIC TEE',5,'100% COTTON',300000,100,b'0'),
	('SP022',3,'BASIC TEE',5,'100% COTTON',300000,100,b'0'),
	('SP023',3,'BASIC TEE',5,'100% COTTON',300000,100,b'0'),
	('SP024',3,'BASIC TEE',5,'100% COTTON',300000,100,b'0'),
	('SP025',3,'BASIC TEE',5,'100% COTTON',300000,100,b'0'),
	('SP026',3,'BASIC TEE',5,'100% COTTON',300000,100,b'0'),
	('SP027',3,'BASIC TEE',5,'100% COTTON',300000,100,b'0'),
	('SP028',3,'BASIC TEE',5,'100% COTTON',300000,100,b'0'),
	('SP029',3,'BASIC TEE',5,'100% COTTON',300000,100,b'0'),
	('SP030',3,'BASIC TEE',5,'100% COTTON',300000,100,b'0'),
	('SP031',3,'BASIC TEE',5,'100% COTTON',300000,100,b'0'),
	('SP032',3,'BASIC TEE',5,'100% COTTON',300000,100,b'0'),
	('SP033',3,'BASIC TEE',5,'100% COTTON',300000,100,b'0'),
	('SP034',3,'BASIC TEE',5,'100% COTTON',300000,100,b'0'),
	('SP035',3,'BASIC TEE',5,'100% COTTON',300000,100,b'0'),
	('SP036',3,'BASIC TEE',5,'100% COTTON',300000,100,b'0'),
	('SP037',3,'BASIC TEE',5,'100% COTTON',300000,100,b'0'),
	('SP038',3,'BASIC TEE',5,'100% COTTON',300000,100,b'0'),
	('SP039',3,'BASIC TEE',5,'100% COTTON',300000,100,b'0'),
	('SP040',3,'BASIC TEE',5,'100% COTTON',300000,100,b'0'),
	...
	('SP054',3,'BASIC TEE',16,'100% COTTON',300000,100,b'0'),
	('SP055',3,'BASIC TEE',16,'100% COTTON',300000,100,b'0'),
	('SP056',3,'BASIC TEE',16,'100% COTTON',300000,100,b'0'),
	('SP057',3,'BASIC TEE',16,'100% COTTON',300000,100,b'0'),
	('SP058',3,'BASIC TEE',16,'100% COTTON',300000,100,b'0'),
	('SP059',3,'BASIC TEE',16,'100% COTTON',300000,100,b'0'),
	('SP060',3,'BASIC TEE',16,'100% COTTON',300000,100,b'0'),
	('SP061',3,'BASIC TEE',16,'100% COTTON',300000,100,b'0'),
	('SP062',3,'BASIC TEE',16,'100% COTTON',300000,100,b'0'),
	('SP063',3,'BASIC TEE',16,'100% COTTON',300000,100,b'0'),
	('SP064',3,'BASIC TEE',17,'100% COTTON',300000,100,b'0'),
	('SP065',3,'BASIC TEE',18,'100% COTTON',300000,100,b'0'),
	('SP066',3,'BASIC TEE',8,'100% COTTON',300000,100,b'0'),
	('SP067',3,'BASIC TEE',8,'100% COTTON',300000,100,b'0'),
	('SP068',3,'BASIC TEE',17,'100% COTTON',300000,100,b'0'),
	('SP069',3,'BASIC TEE',15,'100% COTTON',300000,100,b'0'),
	('SP070',3,'BASIC TEE',15,'100% COTTON',300000,100,b'0'),
	('SP071',3,'BASIC TEE',15,'100% COTTON',300000,100,b'0'),
	('SP072',3,'BASIC TEE',4,'100% COTTON',300000,100,b'0'),
	('SP073',3,'BASIC TEE',4,'100% COTTON',300000,100,b'0'),
	('SP074',3,'BASIC TEE',4,'100% COTTON',300000,100,b'0'),
	('SP075',3,'BASIC TEE',4,'100% COTTON',300000,100,b'0'),
	('SP076',3,'BASIC TEE',4,'100% COTTON',300000,100,b'0'),
	('SP077',3,'BASIC TEE',4,'100% COTTON',300000,100,b'0'),
	('SP078',3,'BASIC TEE',4,'100% COTTON',300000,100,b'0'),
	('SP079',3,'BASIC TEE',4,'100% COTTON',300000,100,b'0'),
	('SP080',3,'BASIC TEE',4,'100% COTTON',300000,100,b'1'),
	('SP081',3,'BASIC TEE',4,'100% COTTON',300000,100,b'0'),
	('SP082',3,'BASIC TEE',4,'100% COTTON',300000,100,b'0'),
	('SP083',3,'BASIC TEE',4,'100% COTTON',300000,100,b'0'),
	('SP084',3,'BASIC TEE',4,'100% COTTON',300000,100,b'0'),
	('SP085',3,'BASIC TEE',4,'100% COTTON',300000,100,b'0'),
	('SP086',3,'BASIC TEE',4,'100% COTTON',300000,100,b'0'),
	('SP087',3,'BASIC TEE',4,'100% COTTON',300000,100,b'0'),
	('SP088',3,'BASIC TEE',4,'100% COTTON',300000,100,b'0'),
	('SP089',3,'BASIC TEE',4,'100% COTTON',300000,100,b'0'),
	('SP090',3,'BASIC TEE',4,'100% COTTON',300000,100,b'0'),
	('SP091',3,'BASIC TEE',4,'100% COTTON',300000,100,b'0'),
	('SP092',3,'BASIC TEE',4,'100% COTTON',300000,100,b'0'),
	('SP093',3,'BASIC TEE',4,'100% COTTON',300000,100,b'0'),
	('SP094',3,'BASIC TEE',7,'100% COTTON',300000,100,b'0'),
	('SP095',3,'BASIC TEE',6,'100% COTTON',300000,100,b'0'),
	('SP096',3,'BASIC TEE',7,'100% COTTON',300000,100,b'0'),
	('SP097',3,'BASIC TEE',5,'100% COTTON',300000,100,b'0'),
	('SP098',3,'BASIC TEE',7,'100% COTTON',300000,100,b'0'),
	('SP099',3,'BASIC TEE',5,'100% COTTON',300000,100,b'0');
